...
void ArenaCameraNode::set_nodes_()
{
  ...
  auto firmware_version = Arena::GetNodeValue<GenICam::gcstring>(nodemap, "DeviceFirmwareVersion");
...
void ArenaCameraNode::set_nodes_transmission_delay_()
{
  if (is_passed_transmission_delay_){
    ...
    log_info(
        std::string("Transmission Delay set to ") + 
